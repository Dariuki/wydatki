...
import 'package:wydatki/data/remote_data_sourse/weather_remote_data_source.dart'
    as _i6;
import 'package:wydatki/domain/ropositories/category_repository.dart' as _i8;
import 'package:wydatki/domain/ropositories/spending_repository.dart' as _i5;
import 'package:wydatki/domain/ropositories/weather_repository.dart' as _i7;
import 'package:wydatki/features/add/cubit/add_cubit.dart' as _i13;
import 'package:wydatki/features/home/cubit/home_cubit.dart' as _i10;
import 'package:wydatki/features/spendings/cubit/spendings_cubit.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.WeatherRepository>(
        () => _i7.WeatherRepository(gh<_i6.WeatherRemoteDataSource>()));
    ...
    gh.factory<_i10.HomeCubit>(() =>
        _i10.HomeCubit(categoriesRepository: gh<_i8.CategoriesRepository>()));
    gh.factory<_i11.SpendingsCubit>(() => _i11.SpendingsCubit(
        spendingsRepository: gh<_i5.SpendingsRepository>()));
    gh.factory<_i12.WeatherCubit>(
        () => _i12.WeatherCubit(gh<_i7.WeatherRepository>()));
    gh.factory<_i13.AddCubit>(() => _i13.AddCubit(
          categoriesRepository: gh<_i8.CategoriesRepository>(),
          spendingsRepository: gh<_i5.SpendingsRepository>(),
        ));
    return this;
  }
